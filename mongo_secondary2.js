...
exports.start = function () {
  ...
  var client = zookeeper.createClient('localhost:2181');
	...
	exec("sudo screen -S replSet1 sudo mongod --port 40000 --dbpath /data/db/replSet1 --replSet Mongo_study --smallfiles --oplogSize 128 --logpath /data/db/replSet_Log/mongo_replSet3.log", function(err, stdout, stderr) {
		sys.puts(stdout);
	});
}
