...
function start() {
  var client = zookeeper.createClient('localhost:2181');
    ...
    exec("mongod --port 40000 --dbpath /data/db/replSet3 --replSet Mongo_study --smallfiles --oplogSize 128 --logpath /data/db/replSet_Log/mongo_replSet3.log", function(error, stdout, stderr) {
        console.log(stdout);
        client.close();
    });
}
